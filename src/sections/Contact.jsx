...
// ─── EMAILJS CONFIG ───────────────────────────────────────────────
// Replace these with your actual EmailJS credentials (see README)
      ...
      <div className="container contact-inner">
        <div className="contact-left">
          ...
          <div className="contact-info">
            <a href="mailto:saqib08011@gmail.com" className="contact-detail">
              ...
              saqib08011@gmail.com
            </a>

            <a href="tel:+917754887782" className="contact-detail">
              <span className="detail-icon">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <a href="https://github.com/saqib7903" target="_blank" rel="noopener noreferrer" className="contact-detail">
              <span className="detail-icon">
              ...
              github.com/saqib7903
            </a>

            <a href="https://www.linkedin.com/in/mohd-saqib-950a78244/" target="_blank" rel="noopener noreferrer" className="contact-detail">
              <span className="detail-icon">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
